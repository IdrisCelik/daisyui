...
To design UI with [Codex](/codex/best-design-skill-2026/), write a product brief plus a component contract. Codex can inspect files, but it needs clear design constraints to avoid low-quality generated markup.
...
Install Blueprint MCP for [on-demand context](/codex/ui-design-mcp-server/):
