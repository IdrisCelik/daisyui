...
[Claude Code skills](/claude-code/ui-design-skill-guide/) can be invoked directly or loaded when relevant. That makes them suitable for reusable UI guidance. A strong design skill should:
...
daisyUI gives Claude Code [Tailwind CSS component names](/tailwind-css/ui-components/) such as btn, card, input, table, modal, and alert. These names create a design vocabulary the agent can repeat.
