...
Claude Code can build frontend features, but generated frontend code gets messy when the agent has no shared component system. A [frontend skill](/claude-code/web-design-skill/) solves that by giving Claude Code reusable instructions before it writes the UI.

## What Claude Code is

[Claude Code](/claude-code/how-to-design-ui/) is an agentic coding tool from Anthropic. It works inside your repository, reads files, edits code, and can run commands while following your instructions.
