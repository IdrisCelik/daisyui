...
To design UI with [Claude Code](/claude-code/free-design-skill/), give Claude a screen goal and a component system. Do not ask for a vague "clean page" and expect consistent design decisions.
...
For on-demand [component context](/claude-code/ui-design-mcp-server/), install Blueprint MCP:
