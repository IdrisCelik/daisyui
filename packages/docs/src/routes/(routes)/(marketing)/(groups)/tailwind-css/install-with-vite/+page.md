...
Vite is a good match for [Tailwind CSS](/tailwind-css/) because it gives you a fast development server and a simple plugin setup. Tailwind CSS 4 uses the `@tailwindcss/vite` plugin in Vite projects.

If you also want [component classes](/tailwind-css/ui-components/), install daisyUI in the same project and load it from your CSS file.
