...
A UI design skill for Cursor gives Agent Mode a preferred [component vocabulary](/cursor/ui-design-skill/). Cursor can inspect nearby files, but a mixed frontend often contains old utility chains, copied examples, and unfinished patterns. A skill tells the agent which path to prefer.
...
The daisyUI skill gives Cursor guidance about component classes, semantic colors, and theme-aware markup. [Agent Skills](/cursor/best-free-component-library/) are designed for this kind of reusable knowledge.
