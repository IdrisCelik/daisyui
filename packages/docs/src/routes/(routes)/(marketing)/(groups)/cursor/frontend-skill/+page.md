...
Cursor is good at editing frontend files, but a code-aware agent still needs a UI system. A [frontend skill](/cursor/ui-design-skill-guide/) gives Cursor the rules it should reuse when building screens, components, and app flows.

## What Cursor is

Cursor is an AI-powered code editor with chat and [Agent Mode](/cursor/how-to-design-ui/) built into the development workflow. It can inspect your files, propose changes, and edit code across a project.
