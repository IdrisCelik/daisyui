...
To design UI with [Cursor](/cursor/frontend-skill/), give Agent Mode a precise screen request and a reusable component source. Cursor can edit quickly, but the prompt still needs a design system.
...
Ask Cursor to inspect nearby UI before generating a new screen. Then tell it to prefer [daisyUI components](/cursor/ui-design-skill-guide/) for repeated controls. This avoids a common failure: a new page that looks isolated from the rest of the app.
